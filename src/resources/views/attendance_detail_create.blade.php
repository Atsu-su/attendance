          ...
          <form action="{{ route('attendance.store', $attendance->id) }}" method="POST">
            ...
            <table class="c-table-detail edit-table">
              ...
              @if ($breakTimes->isEmpty())
                <tr>
                  <th>休憩</th>
                  <td><input class="input-time" type="text" name="break_start_time[]" placeholder="12:00"><span class="wave">～</span><input class="input-time" type="text" name="break_end_time[]" placeholder="13:00">
